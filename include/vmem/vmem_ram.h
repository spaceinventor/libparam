...
#define VMEM_SEC_DEFINE_STATIC_RAM(secname, name_in, strname, size_in) \
...
#define VMEM_DEFINE_STATIC_RAM(name_in, strname, size_in) \
    VMEM_SEC_DEFINE_STATIC_RAM(vmem, name_in, strname, size_in)


#define VMEM_SEC_DEFINE_STATIC_RAM_ADDR(secname, name_in, strname, size_in, mem_addr) \
    static vmem_ram_driver_t vmem_##name_in##_driver = { \
        .physaddr = mem_addr, \
    }; \
    __attribute__((section(#secname))) \
...
#define VMEM_DEFINE_STATIC_RAM_ADDR(name_in, strname, size_in, mem_addr) \
    VMEM_SEC_DEFINE_STATIC_RAM_ADDR(vmem, name_in, strname, size_in, mem_addr)
