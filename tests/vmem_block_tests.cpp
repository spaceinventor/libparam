...
VMEM_DEFINE_BLOCK_REGION(stfw0, "stfw0", 0x0 + (0 * STFW_FIFO_SIZE), STFW_FIFO_SIZE, 0x1000000000ULL + (0 * STFW_FIFO_SIZE), emmc, &vmem_emmc_cache_reg0_cache, 0);
VMEM_DEFINE_BLOCK_REGION(stfw1, "stfw1", 0x0 + (1 * STFW_FIFO_SIZE), STFW_FIFO_SIZE, 0x1000000000ULL + (1 * STFW_FIFO_SIZE), emmc, &vmem_emmc_cache_reg1_cache, 0);
VMEM_DEFINE_BLOCK_REGION(stfw2, "stfw2", 0x0 + (2 * STFW_FIFO_SIZE), STFW_FIFO_SIZE, 0x1000000000ULL + (2 * STFW_FIFO_SIZE), emmc, &vmem_emmc_cache_reg2_cache, 0);
VMEM_DEFINE_BLOCK_REGION(stfw3, "stfw3", 0x0 + (3 * STFW_FIFO_SIZE), STFW_FIFO_SIZE, 0x1000000000ULL + (3 * STFW_FIFO_SIZE), emmc, &vmem_emmc_cache_reg3_cache, 0);
VMEM_DEFINE_BLOCK_REGION(stfw4, "stfw4", 0x0 + (4 * STFW_FIFO_SIZE), STFW_FIFO_SIZE, 0x1000000000ULL + (4 * STFW_FIFO_SIZE), emmc, &vmem_emmc_cache_reg4_cache, 0);
