...
static inline uint16_t param_get_short_id(param_ptr param, unsigned int isarray, unsigned int reserved) {
...
void param_serialize_id(mpack_writer_t *writer, param_ptr param, int offset, param_queue_t *queue) {
...
int param_serialize_to_mpack(param_ptr param, int offset, mpack_writer_t * writer, void * value, param_queue_t * queue) {
...
void param_deserialize_from_mpack_to_param(void * context, void * queue, param_ptr param, int offset, mpack_reader_t * reader) {
