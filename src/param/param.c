...
#define PARAM_GET(_type, _name, _swapfct) \
	_type param_get_##_name##_array(param_ptr param, unsigned int i) { \
	...
	_type param_get_##_name(param_ptr param) { \
...
#define PARAM_SET(_type, name_in, _swapfct) \
	void __param_set_##name_in(param_ptr param, _type value, bool do_callback, unsigned int i) { \
		if (i >= (unsigned int) param->array_size) { \
			return; \
		} \
	...
	inline void param_set_##name_in(param_ptr param, _type value) \
	{ \
		__param_set_##name_in(param, value, true, 0); \
	} \
	inline void param_set_##name_in##_nocallback(param_ptr param, _type value) \
	{ \
		__param_set_##name_in(param, value, false, 0); \
	} \
	inline void param_set_##name_in##_array(param_ptr param, unsigned int i, _type value) \
	{ \
		__param_set_##name_in(param, value, true, i); \
	} \
	inline void param_set_##name_in##_array_nocallback(param_ptr param, unsigned int i, _type value) \
	{ \
